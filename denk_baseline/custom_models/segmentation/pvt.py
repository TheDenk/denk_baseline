...
class PVTv2Net(nn.Module):
    def __init__(self, in_channels, num_classes, encoder_dim=[64, 128, 320, 512]):
        super().__init__()
        self.enc = PyramidVisionTransformerV2(
...
def get_pvt(in_channels, num_classes, pretrained=None, **kwargs):
    model = PVTv2Net(in_channels, num_classes, **kwargs)
    if pretrained:
